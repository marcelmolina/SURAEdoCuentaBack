...
def getheaderpdf(tipo,lista_aux,reporte):
	...
	if tipo=='P':
		lista= [("   ", "   ", "ESTADO DE CUENTA DE "+reporte, "   ", "   "),
				("Nombre del SAT para Sura:", "Seguros SURA S.A. de C.V", "     ", "Nombre del Promotor:", lista_aux[5]),
				...
				("Desde:", lista_aux[9], "   ", "Promotoría a la que pertenece:", " "),
				("Hasta:", lista_aux[10], "   ", "Clave de productor:", " "),
